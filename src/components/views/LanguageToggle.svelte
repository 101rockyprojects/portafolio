...
>
  <span class="lang-text">{$locale === 'en' ? 'English' : 'Español'}</span>
</button>

<style lang="postcss">
  .lang-toggle {
    @apply relative inline-flex items-center justify-center;
    @apply w-fit h-10 px-4 rounded-full font-bold text-sm;
    @apply border-2 border-gold/60 bg-primary/40 text-gold;
